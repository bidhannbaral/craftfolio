  ...
  const sections = [
    {
      ...
      fields: [
        ...
        { id: 'headline', label: 'Professional Headline', type: 'text' },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'tools', label: 'Tools & Technologies', type: 'text' },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-base-200 p-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Simple Template A2 Editor</h1>
