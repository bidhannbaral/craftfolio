    ...
    <div className="max-w-4xl mx-auto p-6 bg-slate-50 rounded-xl shadow-md text-gray-800">
      <div className="relative h-52 mb-36">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[90%] pt-36 text-center bg-white rounded-xl shadow-lg z-10">
          ...
          <div className="text-sm space-y-1 contact-info">
            <p className="flex gap-2 items-center"><strong className="min-w-[80px]">Email:</strong> <span>{email}</span></p>
            <p className="flex gap-2 items-center"><strong className="min-w-[80px]">Phone:</strong> <span className="font-mono">{phone}</span></p>
            <p className="flex gap-2 items-center"><strong className="min-w-[80px]">Address:</strong> <span>{address}</span></p>
          </div>
        </div>
      </div>
